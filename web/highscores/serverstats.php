...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link active" href="serverstats.php"><i class="fas fa-globe-americas"></i> <?php echo $navserver; ?><span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
...
<div class="jumbotron text-center">
  <h1><i class="fas fa-globe-americas"></i> <?php echo $navserver; ?></h1>
  <p> <?php echo $serverdesc; ?></p> 
</div>
<div align="center" class="tables">
<div class="serverdata">
<?php 
if ($pointshop) {
	include 'svstats/pointshop.php';
}
 if ($srvplayers){
	  include 'svstats/players.php';
  }
if ($srvtimeplayed) {
	include 'svstats/playtime.php'; 
}
if ($srvutime) {
	include 'svstats/utime.php';
}?> 
	  </div>
	  </br>
	  <div class="serverdata">
	  <?php
 if ($darkrpserver) {
	include 'svstats/swallet.php'; 
}	
if ($srvkills) {
	 include 'svstats/kill.php';
}
if ($srvdeaths) {
	include 'svstats/death.php';
}
if ($srvheadshots) {
	include 'svstats/headshot.php';
}
	?>
</div>
